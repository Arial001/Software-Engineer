...
public class GrabObjectG2 : MonoBehaviour
{
    ...
    // Referensi ini akan dihapus dari Inspector karena kita akan mencarinya secara dinamis.
    // public ParentObjectNameReaderG2 ParentObjectNameReaderG2;
    ...
    private void Update()
    {
        ...
        if (selectionManager.interaction_Info_UI.activeSelf) // UI aktif
        {
            if (Input.GetKeyDown(moveKey))
            {
                ...
                {
                    Debug.LogWarning("Objek ini tidak dapat direparent.");
                }
